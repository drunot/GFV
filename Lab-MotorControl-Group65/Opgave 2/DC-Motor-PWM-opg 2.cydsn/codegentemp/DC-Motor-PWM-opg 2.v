// ======================================================================
// DC-Motor-PWM-opg 2.v generated from component01.cysch
// 09/19/2019 at 09:51
...
module top ;
	...
	wire [0:0] tmpOE__OUT2_net;
	wire [0:0] tmpFB_0__OUT2_net;
	wire [0:0] tmpIO_0__OUT2_net;
	wire [0:0] tmpINTERRUPT_0__OUT2_net;
	electrical [0:0] tmpSIOVREF__OUT2_net;

	cy_psoc3_pins_v1_10
		#(.id("397e26f3-ddde-40b2-82d6-b6f2c9a29920"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		OUT2
		 (.oe(tmpOE__OUT2_net),
		  .y({Net_101}),
		  .fb({tmpFB_0__OUT2_net[0:0]}),
		  .io({tmpIO_0__OUT2_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT2_net),
		  .interrupt({tmpINTERRUPT_0__OUT2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
